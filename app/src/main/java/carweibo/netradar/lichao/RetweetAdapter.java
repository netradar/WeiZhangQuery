...
public class RetweetAdapter extends SimpleAdapter implements ImageCallback {
	...
	public RetweetAdapter(Context context, List<? extends Map<String, ?>> data,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(rowView==null)
		{
            ...
            rowView = inflater.inflate(R.layout.retweet_item_layout, null);
